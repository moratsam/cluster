...
func (x *queueSubscribeClient) Recv() (*msg.Msg, error) {
	m := new(msg.Msg)
...
func (c *queueClient) Publish(ctx context.Context, in *msg.Msg, opts ...grpc.CallOption) (*Ack, error) {
	out := new(Ack)
...
func (UnimplementedQueueServer) Publish(context.Context, *msg.Msg) (*Ack, error) {
...
func (x *queueSubscribeServer) Send(m *msg.Msg) error {
...
func _Queue_Publish_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueueServer).Publish(ctx, req.(*msg.Msg))
	}
